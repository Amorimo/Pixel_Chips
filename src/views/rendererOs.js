...
frmOS.addEventListener('submit', async (event) => {
    ...
    if (idClient.value === "") {
        ...
        console.log(idOS.value, idClient.value, nameClient.value, phoneClient.value, statusOS.value, computer.value, serial.value, problem.value, obs.value, specialist.value, diagnosis.value, parts.value, total.value)
        if (idOS.value === "") {
            //Gerar OS
...
api.renderOS((event, dataOS) => {
    ...
    computer.value = os.console
    serial.value = os.modelo
